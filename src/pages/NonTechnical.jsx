  ...
  return (
    <main className="relative bg-black min-h-screen w-full md:px-[unset]">
      <section className="relative w-full h-[40vh] md:h-[50vh] bg-arcane-primary">
        ...
        <h2 className="absolute z-20 pt-14 font-bold text-center w-full text-white transform -translate-x-1/2 -translate-y-1/2 text-5xl md:text-8xl top-1/2 left-1/2 font-valorax">
